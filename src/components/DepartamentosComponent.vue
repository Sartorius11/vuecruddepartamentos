    ...
    <table class="table table-bordered table-warning">
        ...
        <tbody>
            <tr v-for="dept in departamentos" :key="dept.numero">
                ...
                <!-- este router link te lleva alas rutas y esta te lleva a detalles departamento y le pasas los datos -->
                <td>
                    <router-link :to="'/details/'+dept.numero+'/'+dept.nombre+'/'+dept.localidad" 
                    class="btn btn-success">Details</router-link>
                   
                    <router-link :to="'/update/'+ dept.numero" class="btn btn-success">
                        Edit
                    </router-link>
